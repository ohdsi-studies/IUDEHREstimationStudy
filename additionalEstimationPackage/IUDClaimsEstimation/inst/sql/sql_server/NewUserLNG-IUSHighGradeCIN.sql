...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4275113,2718682,44045536,40001198,44097167,2110194,44073214,44123197,44086126,43020952,915800,915801,937575,937612,2718683,2721260,44786565,44786600)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4275113,2718682,44045536,40001198,44097167,2110194,44073214,44123197,44086126,43020952,915800,915801,937575,937612,2718683,2721260,44786565,44786600)
...
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (43020952,2721260,44123197,44097167,44086126,44045536,44073214,40001198,2718683,937612,937575,915800,915801,44786565,44786600)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (43020952,2721260,44123197,44097167,44086126,44045536,44073214,40001198,2718683,937612,937575,915800,915801,44786565,44786600)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (40001199)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (40001199)
  and c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4116358,196364,192676,4061209,4023453,4219339,4108901,4061049,4283743,4289386,4281162,4280498)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4116358,196364,192676,4061209,4023453,4219339,4108901,4061049,4283743,4289386,4281162,4280498)
  and c.invalid_reason is null
...
JOIN #Codesets codesets on ((de.drug_concept_id = codesets.concept_id and codesets.codeset_id = 46))
) C

WHERE C.drug_exposure_start_date >= DATEFROMPARTS(2003, 01, 01)
AND C.ordinal = 1
